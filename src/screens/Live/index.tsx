...
const Live: React.FC = () => {
  ...
  async function startVideo(index: number) {
    console.log(liveRoom.current, index);
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <View
        ...
        ref={warp}
        onLayout={() => {
          warp.current.measure(
            (x: any, y: any, w: any, h: React.SetStateAction<number>) => {
          ...
          renderItem={({ item, index }) => (
            ...
            >
              ...
              >
                ...
                <LiveTitle
                  liveTitle={liveList[currentIndex].live_room.name}
                  liveUser={liveList[currentIndex].user.username}
                />
              </View>
            </View>
          )}
